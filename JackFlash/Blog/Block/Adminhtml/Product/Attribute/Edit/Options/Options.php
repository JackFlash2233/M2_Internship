...
namespace JackFlash\Blog\Block\Adminhtml\Product\Attribute\Edit\Options;
...
class Options extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'JackFlash_Blog::catalog/product/attribute/options.phtml';
    ...
    protected function _prepareUserDefinedAttributeOptionValues($option, $inputType, $defaultValues)
    {
        ...
        $value['checked1'] = ($isEnabled == '1') ? 'checked="checked"' : '';
